# Deprecations here: http://robots.thoughtbot.com/shoulda-matchers-2-0
require 'spec_helper'
...
describe Devise::Oauth2Providable::AuthorizationsController do
  describe 'GET #new' do
    context 'with valid redirect_uri' do
      ...
      pending { should assign_to(:redirect_uri).with(redirect_uri) }
      pending { should assign_to(:response_type) }
